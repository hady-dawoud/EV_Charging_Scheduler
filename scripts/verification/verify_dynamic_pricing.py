...
def print_option(prefix: str, option) -> None:
    ...
    print(f"  final_price_per_kwh: {metadata.get('final_price_per_kwh', metadata.get('price_per_kwh', 'n/a'))}")
    print(f"  tariff_class: {metadata.get('tariff_class', 'n/a')}")
    print(f"  selected_connector_type: {metadata.get('selected_connector_type', 'n/a')}")
    print(f"  selected_connector_power_kw: {metadata.get('selected_connector_power_kw', 'n/a')}")
    print(f"  total_dynamic_multiplier: {metadata.get('total_dynamic_multiplier', 'n/a')}")
