...
The current recommender is a deterministic weighted heuristic baseline. It should be kept as the explainable baseline before MARL checkpoint inference is added.
...
The current recommendation output is generated by deterministic weighted heuristic scoring. It is not learned MARL inference yet.
